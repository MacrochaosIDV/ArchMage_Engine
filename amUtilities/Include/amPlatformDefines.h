...
/**
*******************************************************************************
*  Disable 4byte type multiplication warning
*******************************************************************************
*/
...
*  Engine explicitly uses enums that implicitly convert to int32/uint32
*******************************************************************************
*/
...
/**
*******************************************************************************
*  Disable uninitialized member variable warning
*  Some variables in the engine are ptrs or structs that
