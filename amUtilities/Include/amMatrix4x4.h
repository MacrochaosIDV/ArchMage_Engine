...
namespace amEngineSDK {
  ...
  public:
    ...
    ***********************/
    ...
    /***********************
    *  @brief Constructs the matrix with 
    ***********************/
    ...
    ***********************/
    amMatrix4x4 Translation_RH(float dx, float dy, float dz);

    /***********************
    *  @brief Translates this matrix by the given amount in RADIANS (Left handed rotations)
    ***********************/
    amMatrix4x4 Translation_LH(float dx, float dy, float dz);

    amMatrix4x4 Scaling(float sx, float sy, float sz);
    ...
    ***********************/
    ...
    amMatrix4x4 Fast_Inverse(amMatrix4x4& M);
